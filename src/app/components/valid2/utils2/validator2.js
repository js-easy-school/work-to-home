...
const data = {
    name: '', // Изменено значение полей "name" и "email" на пустые строки для тестирования валидации
...
const config = {
    ...
    email: {
        ...
        isRequired: {
        // Правило "isRequired"
            message: 'Email не должен быть пустым' // Сообщение об ошибке
        }
    }
};
...
console.log(errors); // { name: 'Имя не должно быть пустым', email: 'Email не должен быть пустым' }
